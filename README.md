...
Затем вводите номер телефона привязанный к **ВАШЕМУ** телеграму и код, который скоро придёт к вам, как на картинке<br>
...
messages_per_second - ставьте число до 10 (кол-во сообщений в секунду)
